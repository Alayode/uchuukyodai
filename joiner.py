...
hese Python scripts inspiration came from Jiseng So I rewritten so it can join .wav files rather then .ogg . 
They are provided for use in however you see fit, but also come as-is. 
I take no responsibility for any damage you may cause them. It's good practice 
to take a look at what you're running before you run them anyhow!
...
# A simple script  that joins all .wav files in the current directory. Meant to overcome the size limitation of shnjoin. Still limited to 4GB, since that is a limitation of the format.
